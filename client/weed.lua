...
RegisterNetEvent("lusty94_weed:pickWeed", function()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		if not isPickingUp then
			...
			QBCore.Functions.Progressbar("search_register", "Picking Weed", 5000, false, true, {
				...
				spawnedWeeds -= 1
				TriggerServerEvent('lusty94_weed:pickedUpCannabis')
				isPickingUp = false
			end, function()
				ClearPedTasks(PlayerPedId())
				isPickingUp = false
